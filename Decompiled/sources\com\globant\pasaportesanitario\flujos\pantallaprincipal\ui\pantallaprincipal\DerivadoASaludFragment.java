...
@Instrumented
public class DerivadoASaludFragment extends Fragment implements TraceFieldInterface {
    ...
    private void escucharCambiosDelUsuario() {
        this.mViewModel.obtenerUltimoEstadoLiveData().a(requireActivity(), new r<UsuarioBD>() {
            public void onChanged(UsuarioBD usuarioBD) {
                DerivadoASaludFragment.this.mViewModel.despacharEventoNavegacion();
                DerivadoASaludFragment.this.setTiempo(usuarioBD);
            }
        });
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        String str = "DerivadoASaludFragment#onCreateView";
        try {
        ...
        ((TextView) inflate.findViewById(R.id.diagnostico)).setText(R.string.derivado_a_salud_local_banner);
        TextView textView = (TextView) inflate.findViewById(R.id.aislado);
        if (textView != null) {
            textView.setText(getString(R.string.estado_aislado_texto));
        }
            ...
            public void onClick(View view) {
                a.a(view.getContext(), (int) R.string.pregunta_actualizar_certificado, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i) {
                        DerivadoASaludFragment.this.mViewModel.obtenerUltimoEstadoDeBackend();
                    }
                });
            }
        });
        ...
        textView2.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                a.a(view.getContext(), (int) R.string.pregunta_desvincular_dni, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i) {
                        DerivadoASaludFragment.this.mViewModel.logout();
                        IdentificacionActivity.iniciarEliminandoPilaNavegacion(DerivadoASaludFragment.this.requireContext());
                    }
                });
            }
        });
        ...
        textView3.setOnClickListener(new OnClickListener() {
            public void onClick(final View view) {
                ...
                ResultadoActivity.iniciar(DerivadoASaludFragment.this.getActivity(), OpcionesNavegacion.RESULTADO_ROSA);
